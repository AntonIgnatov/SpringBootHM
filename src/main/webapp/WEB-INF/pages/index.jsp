...
<html>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li><button type="button" id="add_group_full" class="btn btn-default navbar-btn">Add group with contacts</button></li>
                            <li class="dropdown">
        ...
        <script>
            ...
            $('#add_group_full').click(function(){
                window.location.href='/group_add_contacts';
            });
        </script>
    </body>
</html>